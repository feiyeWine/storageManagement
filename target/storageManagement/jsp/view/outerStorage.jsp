    ...
    <tbody>
        <c:forEach items="${goods}" var="good">
            <tr>
                ...
                <td class="actions"><a class="modalA" href="#myModal"  data-toggle="modal" title="商品出库">出库<img src="jsp/img/icons/actions/edit.png" alt="" /></a>
            </tr>
        </c:forEach>
    </tbody>
</table>
                ...
                <div>
                    <form id="modalForm" name="modalForm" class="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <label class="">库存总数量：<span id="total" name="total" ></span></label><br/>
                            <label class="">出库数量：<input class="input-sm" type="number"  min="0" value="0" id="amount" name="checked" /></label>
                        </div>
    ...
    $(function(){
        ...
        $("#submit").click(function(){
            ...
            if($("#total").text()>=$("#amount").val()) {
                ...
                //出库操作
                $.post("/storageManagement/outerStorage.do", $("#modalForm").serialize(), function (data) {
