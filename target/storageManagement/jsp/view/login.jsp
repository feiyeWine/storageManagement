...
<link rel="stylesheet" type="text/css" href="jsp/login/css/style.css" />
<link rel="stylesheet" type="text/css" href="jsp/login/css/animate.css" />

<script type="text/javascript" src="jsp/login/js/login.js"></script>
...
<h2 align="center" style="font-size: 36px;">玫琳凯西安分店库存管理系统</h2>
...
<div class="LoginWindow">
	<div>
        <form action="login.do" method="post">
            <div class="login">
                <p>管理员：<input type="radio" checked="checked" name="Sex" value="管理员" />
                    仓管员：<input type="radio"  name="Sex" value="仓管员" />
                </p>
